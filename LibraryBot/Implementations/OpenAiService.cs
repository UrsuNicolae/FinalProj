...
namespace LibraryBot.Implementations
{
    public class OpenAiService : IOpenAiService
    {
        ...
        public Task<string> GetBookRecommandations(BookDto book, AuthorDto authorDto, CategoryDto categoryDto, int count, CancellationToken ct)
        {
